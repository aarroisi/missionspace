defmodule Missionspace.Emails do
  import Swoosh.Email

  @from_name "Mission Space"

  defp from_email do
    Application.get_env(:missionspace, :from_email, "noreply@missionspace.co")
  end

  defp frontend_url do
    Application.get_env(:missionspace, :frontend_url, "http://localhost:5173")
  end
