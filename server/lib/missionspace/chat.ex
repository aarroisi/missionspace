defmodule Missionspace.Chat do
  @moduledoc """
  The Chat context.
  """
  ...
  alias Missionspace.Chat.{Channel, DirectMessage, Message, ReadPosition}
  ...
  def list_starred_channels(workspace_id, user, opts \\ []) do
    starred_ids = Missionspace.Stars.starred_ids(user.id, "channel")
  ...
  defp filter_accessible_channels(query, %{id: user_id}) do
    project_channel_ids =
      Missionspace.Projects.get_project_item_ids_for_user_projects(user_id, "channel")

    item_member_ids = Missionspace.Projects.get_user_item_member_ids(user_id, "channel")
  ...
  def list_starred_direct_messages(workspace_id, user_id, opts \\ []) do
    starred_ids = Missionspace.Stars.starred_ids(user_id, "direct_message")
