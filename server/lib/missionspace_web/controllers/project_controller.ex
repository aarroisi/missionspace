defmodule MissionspaceWeb.ProjectController do
  ...
  def index(conn, params) do
    ...
    entries = Missionspace.Stars.mark_starred(page.entries, user.id, "project")
  ...
  def create(conn, params) do
    ...
    with {:ok, project} <- Projects.create_project(project_params) do
      ...
      project = Missionspace.Repo.preload(project, :created_by)
  ...
  def show(conn, _params) do
    user = conn.assigns.current_user
    project = Missionspace.Stars.mark_starred(conn.assigns.project, user.id, "project")
