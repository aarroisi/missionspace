defmodule MissionspaceWeb.ChannelController do
  ...
  def index(conn, params) do
    ...
    entries = Missionspace.Stars.mark_starred(page.entries, user.id, "channel")
  ...
  def show(conn, _params) do
    user = conn.assigns.current_user
    channel = Missionspace.Stars.mark_starred(conn.assigns.channel, user.id, "channel")
