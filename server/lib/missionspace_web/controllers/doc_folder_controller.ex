defmodule MissionspaceWeb.DocFolderController do
  use MissionspaceWeb, :controller

  alias Missionspace.Docs
  alias Missionspace.Namespaces
  ...
  def index(conn, params) do
    ...
    entries = Missionspace.Stars.mark_starred(page.entries, user.id, "doc_folder")
  ...
  def show(conn, _params) do
    user = conn.assigns.current_user
    folder = Missionspace.Stars.mark_starred(conn.assigns.doc_folder, user.id, "doc_folder")
