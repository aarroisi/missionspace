defmodule MissionspaceWeb.ListControllerTest do
  ...
  describe "create" do
    ...
    test "sets workspace to current user's workspace", %{
      ...
      list = Missionspace.Repo.get!(Missionspace.Lists.List, list_id)
    ...
    test "sets created_by_id to current user", %{conn: conn, user: user} do
      ...
      list = Missionspace.Repo.get!(Missionspace.Lists.List, response["data"]["id"])
