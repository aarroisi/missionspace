defmodule MissionspaceWeb.DocFolderControllerTest do
  ...
  describe "create" do
    ...
    test "sets workspace to current user's workspace", %{conn: conn, workspace: workspace} do
      ...
      folder = Missionspace.Repo.get!(Missionspace.Docs.DocFolder, response["data"]["id"])
    ...
    test "rejects duplicate prefix within workspace (cross-type collision)", %{
      ...
      {:ok, _list} =
        Missionspace.Lists.create_list(%{
          "name" => "A Board",
          "prefix" => "DUP",
